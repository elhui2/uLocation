...
--
-- Servidor: localhost
-- Tiempo de generación: 29-03-2018 a las 05:49:43
...
INSERT INTO `places` (`id_place`, `name`, `url`, `description`, `image`, `address`, `lat`, `lng`, `id_user`, `dt_modify`) VALUES
(10, 'Parque de los ciervos', 'parque-de-los-ciervos', '<h1>Hello World!</h1>', '511667ed07598bfdc9e91110fb476555.jpg', 'Ave Parque de los Ciervos s/n, Chiluca Valle Escondido, Cd López Mateos, Méx.', 19.5721347, -99.28756870000001, 1, '2018-03-29 05:22:27'),
...
(17, 'Parque nacional Los Mármoles', 'parque-nacional-los-marmoles', '<p>El 12 de agosto de 1936, el presidente constitucional de los Estados Unidos Mexicanos general L&aacute;zaro C&aacute;rdenas del R&iacute;o, anunci&oacute; la creaci&oacute;n del &aacute;rea \"Los M&aacute;rmoles\" en categor&iacute;a de parque nacional. El decreto entr&oacute; en vigor el 8 de septiembre de 1936.1​Sin embargo, desde entonces ha carecido de una administraci&oacute;n interesada en conservar sus recursos naturales y belleza esc&eacute;nica.</p>', '', 'A 126 kilómetros de la ciudad de Pachuca, Se localiza geográficamente entre los meridianos de coordenadas 99°08\'55’’ y 99°18’37’’ de longitud oeste, y entre los paralelos de 20°45’33’’ y 20°58’47’’ de latitud norte.', 20.8688042, -99.21205929999996, 1, '2018-03-29 04:50:57');
...
--
ALTER TABLE `users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Indice Unico', AUTO_INCREMENT=2;COMMIT;
